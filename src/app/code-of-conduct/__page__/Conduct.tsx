  ...
  return (
    <Box maxW="800px" mx="auto" p={6} my={20}>
      ...
      <Text fontSize="lg" mb={4}>
        Following in the example of our partners at{" "}
        <Link
          color="codeBlue.400"
          target="_blank"
          href="https://codeandcoffee.org/code-of-conduct"
        >
          Code & Coffee
        </Link>
        , Mitobyte (and all the events under its control) is dedicated to
        providing a harassment-free experience for everyone, regardless of level
        of experience, gender, gender identity and expression, sexual
        orientation, disability, physical appearance, body size, race, age, or
        religion. We do not tolerate harassment of group participants in any
        form. Sexual language and imagery is not appropriate for any event or
        communication channel. Group participants violating these rules may be
      ...
      <Text fontSize="lg" mb={4}>
        ...
        immediately. If a participant engages in harassing behavior, event
      ...
      <Text fontSize="lg" mb={4}>
        ...
        report it as soon as possible. Group organizers can be identified on
        Meetup. Harassment and other code of conduct violations reduce the value
        of our event for everyone. We want you to be happy at our event. People
      ...
      <Text fontSize="lg" mb={4}>
        You can make an anonymous report. We can't follow up an anonymous report
