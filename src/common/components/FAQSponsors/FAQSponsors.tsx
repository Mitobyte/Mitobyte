...
const FAQ = [
  ...
  },
  {
    ...
    content: 'Getting started is easy! Simply reach out to us through our contact form, and we’ll set up a time to discuss the sponsorship opportunities available. We look forward to partnering with you to make a meaningful impact on the tech community.'
  }
];
